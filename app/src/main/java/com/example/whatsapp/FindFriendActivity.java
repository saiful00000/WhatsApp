    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Contacts, FindFriendViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull FindFriendViewHolder holder, final int position, @NonNull Contacts model) {
                ...
                Picasso.get().load(model.getProfile_image())/*.placeholder(R.drawable.profile_image)*/.into(holder.userImageView);

                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String visitUserId = getRef(position).getKey();
                        // sent current user to show information of selected user
                        Intent intent = new Intent(FindFriendActivity.this, OtherUserProfileActivity.class);
